window.RELICS = {
  common: [
    ...
    { id:"medal", name:"战士勋章", hook:"onBattleStart", effect:{"extraDraw":2}, description:"每场战斗开始额外抽 2 张牌" }
  ],
  rare: [
    ...
    { id:"sage_scroll", name:"贤者卷轴", hook:"onBattleStart", effect:{"abilityCostReduce":1}, description:"所有能力牌费用 -1" }
  ],
  legendary: [
...
window.getAllRelics = function() { return [...window.RELICS.common, ...window.RELICS.rare, ...window.RELICS.legendary]; };
window.getRelicById = function(id) { return window.getAllRelics().find(function(r){return r.id===id;}) || Object.values(window.RELICS.unlock).find(function(r){return r.id===id;}) || null; };
